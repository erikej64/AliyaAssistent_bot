...
def get_system_prompt() -> str:
    now = datetime.utcnow() + timedelta(hours=5)  # UTC+5 Астана
...
После сбора всех 4 пунктов — напиши подтверждение (время в часовом поясе клиента и по Астане), затем добавь строку:
ЗАПИСЬ: Имя: {{имя}} | Город: {{город}} | Дата: {{ГГГГ-ММ-ДД}} | Время: {{ЧЧ:ММ}} | Запрос: {{запрос}}

Время в строке ЗАПИСЬ — только цифры ЧЧ:ММ по Астане, без слов.
